    ...
    internal class Shop
    {
        ...
        static void LoadItemCSV(List<Item> _storeItems)
        {
            ...
            for (int i = 0; i < CSVLine.Length; i++)
            {
                ...
                Item.ClassRestricted _restricted = (Item.ClassRestricted)(int.Parse(itemSetting[4]));
                int _price = int.Parse(itemSetting[5]);

                Item item = new Item(_name, status, _description, _restricted, type, _price);
